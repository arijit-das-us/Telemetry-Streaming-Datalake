...
// MAGIC unix_timestamp >= 1622505600 and unix_timestamp < 1625097600 and 
...
// MAGIC and unixTimestamp >= 1622505600 and unixTimestamp < 1625097600
...
// MAGIC order by unixTimestamp asc, remoteId

// COMMAND ----------

// MAGIC %sql
// MAGIC select * from MetricGold where metricProviderId = 3 
// MAGIC and kymetaMetricId = 214
...
// MAGIC and unixTimestamp >= 1626998400 --and unixTimestamp < 1612137600
