...
val SourcekafkaTopic="hubstats"
val kafkaTopicToPublish = "Hubstats-Published"
...
val POLYBASE_TEMP_DIR = "wasbs://kite-int@kymetabigdata.blob.core.windows.net/ploybase"
...
val custommetricsURL = "http://kymetacloudservicesremotemetrics.azurewebsites.net/v2.0/config/custommetricmappings"
