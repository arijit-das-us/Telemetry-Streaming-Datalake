...
val SourcekafkaTopic="hubusage-prod"
val kafkaTopicToPublish = "Hubusage-Published"
println("Finished setting Kafka broker and topic configuration for tpoic hubusage.")
