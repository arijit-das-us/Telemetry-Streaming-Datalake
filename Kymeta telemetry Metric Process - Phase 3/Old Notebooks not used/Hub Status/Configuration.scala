...
val SourcekafkaTopic="hubstatus-prod"
val kafkaTopicToPublish = "Hubstatus-Published"
println("Finished setting Kafka broker and topic configuration for tpoic hus status.")
