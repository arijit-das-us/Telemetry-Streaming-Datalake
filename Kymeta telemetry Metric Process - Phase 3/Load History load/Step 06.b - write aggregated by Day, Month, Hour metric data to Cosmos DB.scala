...
val dfAggDayMetric = spark.read
  ...
  .filter($"unixTimestamp" >= 1612137600 and $"unixTimestamp" < 1614556800)
...
display(dfAggDayMetricCosmos.filter($"kymetaMetricId" === 9003 and $"remoteId" === "01bcae4e-f8f9-4c89-9cdd-d8a8cb25f56e" and $"metricProviderId" === 2).orderBy("unixTimestamp"))
