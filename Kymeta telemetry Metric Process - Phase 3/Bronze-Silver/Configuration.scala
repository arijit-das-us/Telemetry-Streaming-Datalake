...
val SourcekafkaTopicPeplink="peplink-prod"
val SourcekafkaTopicCubic="cubicusage-prod"
val SourcekafkaTopicASM="asm-prod"
val SourcekafkaTopicEvo="evo-prod"
val SourcekafkaTopicTran="transec-prod"
val SourcekafkaTopicHubstats="hubstats-prod"
val SourcekafkaTopicHubstatus="hubstatus-prod"
val SourcekafkaTopicHubusage="hubusage-prod"
val SourcekafkaTopicIntelsatusage="intelsatusage-prod"

println("Finished setting Kafka broker and topic configuration for tpoic Peplink.")
...
val POLYBASE_TEMP_DIR = "wasbs://poc@kymetabigdata.blob.core.windows.net/tempdir"
...
val metricmappingsURL = "http://kymetacloudservicesremotemetrics.azurewebsites.net/v2.0/config/metricmappings"
val metricprovidersURL = "http://kymetacloudservicesremotemetrics.azurewebsites.net/v2.0/config/metricproviders"
val metricsURL = "http://kymetacloudservicesremotemetrics.azurewebsites.net/v2.0/config/metrics"
